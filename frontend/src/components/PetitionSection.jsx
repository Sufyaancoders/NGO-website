...
const PetitionSection = () => {
  return (
    <section className="py-16 px-6 md:px-12 lg:px-24 bg-white absolute w-full z-10">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-petition-text text-lg">
          ...
          <div className="bg-petition-card p-8 md:p-10 h-fit">
            <h2 className="text-3xl md:text-4xl font-bold text-petition-heading mb-6">
              Sign the petition!
            </h2>
            
            <p className="text-petition-text mb-6 leading-relaxed">
            ...
            <ul className="space-y-4 mb-6">
              <li className="flex gap-3">
                ...
                <span className="text-petition-text">
            ...
            <p className="text-petition-text mb-8 leading-relaxed">
            ...
            <Button 
              className="w-full bg-blue-800 hover:bg-blue-700 text-white font-bold text-sm tracking-wider uppercase py-6"
              size="lg"
            >
              SIGN NOW
            </Button>
