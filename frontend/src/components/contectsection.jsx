...
export default function CommunitySection() {
    return (
        <section className="py-20 w-full bg-[#1409e6]  text-white md:py-28">
            <div className="mx-auto max-w-5xl px-6">
                ...
                <div className="mx-auto mt-12 flex max-w-lg flex-wrap justify-center gap-3">
                    <Link to="https://github.com/meschacirung" target="_blank" rel="noopener noreferrer" title="Méschac Irung" className="size-16 rounded-full border *:size-full *:rounded-full *:object-cover">
