  ...
  return (
    <Card className="border-0 shadow-none bg-sky-100 overflow-hidden shrink-0  w-full md:w-[450px] animate-fade-scale group">
      ...
      <CardContent className="bg-grey p-8 space-y-4 ">
        ...
        <Button 
          onClick={onReadMore}
          className="bg-blue-800 text-white hover:bg-blue-600 font-bold uppercase tracking-wide px-8 py-6 text-sm transition-all duration-300 hover:scale-105 hover:shadow-md"
        >
          Read More
        </Button>
      </CardContent>
