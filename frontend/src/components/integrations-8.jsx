    ...
    return (
        <section>
            <div className="bg-muted dark:bg-background py-24 md:py-32">
                <div
                    className="mx-auto flex flex-col px-6 md:grid md:max-w-5xl md:grid-cols-2 md:gap-12">
                    <div className="order-last mt-6 flex flex-col gap-12 md:order-first">
                        <div className="space-y-6">
                            ...
                            <p className="text-[#b5a9a9]">Connect seamlessly with popular platforms and services to enhance your workflow.</p>
                        ...
                        <div className="mt-auto grid grid-cols-[auto_1fr] gap-3">
                            <div
                                className="bg-white flex aspect-square items-center justify-center border">
                            ...
                            <blockquote>
                                ...
                                <div className="mt-2 flex gap-2 text-sm">
                                    <cite>John Doe</cite>
                                    <p className="text-white">Founder, MediaWiki</p>
                                </div>
                            </blockquote>
                        </div>
                    </div>
...
const Integration = ({
    ...
    return (
        <div
            className="hover:bg-muted dark:hover:bg-muted/50 space-y-4 rounded-lg border p-4 transition-colors">
